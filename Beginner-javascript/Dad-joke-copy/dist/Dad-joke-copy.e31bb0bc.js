...
const buttonText = ['omg', 'ohh nice', 'omg dad', 'you are the worst', 'seriously', 'stop it.', 'please stop', 'that was the worst one'];
...
async function handleClick() {
  const {
    joke
  } = await fetchJoke(); // console.log(joke);
...
//# sourceMappingURL=/Dad-joke-copy.e31bb0bc.js.map